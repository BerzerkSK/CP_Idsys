<?php
// source: D:\Programy\xampp\htdocs\CP_Idsys\app/config/config.neon 
// source: D:\Programy\xampp\htdocs\CP_Idsys\app/config/config.local.neon 

class Container_14aacf3414 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\CredentialsAuthenticator' => [1 => ['24_App_Model_CredentialsAuthenticator']],
			'App\Model\PriceOfferManager' => [1 => ['25_App_Model_PriceOfferManager']],
			'App\components\IItemPriceOfferFormFactory' => [1 => ['26_App_components_IItemPriceOfferFormFactory']],
			'App\components\IPriceOfferFormFactory' => [1 => ['27_App_components_IPriceOfferFormFactory']],
			...
			'App\Presenters\ItemPriceOfferPresenter' => [1 => ['application.4']],
			'App\Presenters\PriceOfferPresenter' => [1 => ['application.5']],
			'NetteModule\ErrorPresenter' => [1 => ['application.6']],
			'NetteModule\MicroPresenter' => [1 => ['application.7']],
			'Nette\DI\Container' => [1 => ['container']],
		],
		'services' => [
			'24_App_Model_CredentialsAuthenticator' => 'App\Model\CredentialsAuthenticator',
			'25_App_Model_PriceOfferManager' => 'App\Model\PriceOfferManager',
			'26_App_components_IItemPriceOfferFormFactory' => 'App\components\ItemPriceOfferForm',
			'27_App_components_IPriceOfferFormFactory' => 'App\components\PriceOfferForm',
			...
			'application.4' => 'App\Presenters\ItemPriceOfferPresenter',
			'application.5' => 'App\Presenters\PriceOfferPresenter',
	...
	{
		parent::__construct([
			'appDir' => 'D:\Programy\xampp\htdocs\CP_Idsys\app',
			'wwwDir' => 'D:\Programy\xampp\htdocs\CP_Idsys\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\Programy\xampp\htdocs\CP_Idsys\app/../temp',
		]);
	}


	/**
	 * @return App\Model\CredentialsAuthenticator
	 */
	public function createService__24_App_Model_CredentialsAuthenticator()
	{
		$service = new App\Model\CredentialsAuthenticator($this->getService('security.user'),
	...
	/**
	 * @return App\Model\PriceOfferManager
	 */
	public function createService__25_App_Model_PriceOfferManager()
	{
		$service = new App\Model\PriceOfferManager($this->getService('database.default.context'),
	...
	/**
	 * @return App\components\IItemPriceOfferFormFactory
	 */
	public function createService__26_App_components_IItemPriceOfferFormFactory()
	{
		return new Container_14aacf3414_App_components_IItemPriceOfferFormFactoryImpl_26_App_components_IItemPriceOfferFormFactory($this);
	}


	/**
	 * @return App\components\IPriceOfferFormFactory
	 */
	public function createService__27_App_components_IPriceOfferFormFactory()
	{
		return new Container_14aacf3414_App_components_IPriceOfferFormFactoryImpl_27_App_components_IPriceOfferFormFactory($this);
	}
	...
	public function createServiceApplication__1()
	{
		...
		$service->priceOfferManager = $this->getService('25_App_Model_PriceOfferManager');
		$service->priceOfferFormFactory = $this->getService('27_App_components_IPriceOfferFormFactory');
		$service->itemPriceOfferFormFactory = $this->getService('26_App_components_IItemPriceOfferFormFactory');
		$service->credentialsAuthenticator = $this->getService('24_App_Model_CredentialsAuthenticator');
	...
	/**
	 * @return App\Presenters\ItemPriceOfferPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\ItemPriceOfferPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\PriceOfferPresenter
	 */
	public function createServiceApplication__5()
	{
		$service = new App\Presenters\PriceOfferPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\Programy\xampp\htdocs\CP_Idsys\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\Programy\xampp\htdocs\CP_Idsys\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\Programy\xampp\htdocs\CP_Idsys\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=idsys', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_14aacf3414_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_14aacf3414_App_components_IItemPriceOfferFormFactoryImpl_26_App_components_IItemPriceOfferFormFactory implements App\components\IItemPriceOfferFormFactory
{
	private $container;


	public function __construct(Container_14aacf3414 $container)
	{
	...
	{
		$service = new App\components\ItemPriceOfferForm($param, $this->container->getService('25_App_Model_PriceOfferManager'),
...
class Container_14aacf3414_App_components_IPriceOfferFormFactoryImpl_27_App_components_IPriceOfferFormFactory implements App\components\IPriceOfferFormFactory
{
	private $container;
	...
	public function create($param = NULL)
	{
		$service = new App\components\PriceOfferForm($param, $this->container->getService('25_App_Model_PriceOfferManager'),
			$this->container->getService('security.user'));
		return $service;
	}
...
class Container_14aacf3414_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\Programy\xampp\htdocs\CP_Idsys\app/../temp/cache/latte');

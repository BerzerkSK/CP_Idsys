<?php
// source: D:\Programy\xampp\htdocs\CP_Idsys\app/templates/@layout.latte

use Latte\Runtime as LR;

class Templatef2cdd3ce74 extends Latte\Runtime\Template
{
	public $blocks = [
		'head' => 'blockHead',
		'title' => 'blockTitle',
...
?>Cenové ponuky</title>
	...
	<link rel="stylesheet" href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 14 */ ?>/css/style.css">
        ...
        <style>
                ...
                body { font: 14px/1.65 Verdana, "Geneva CE", lucida, sans-serif; background: #3484d2; color: #333; margin: 38px auto; max-width: 1204px; min-width: 960px; }
                ...
                #banner { border-radius: 12px 12px 5px 5px; background-image: url(data:image/png;base64,); }
                ...
                #content, #content2 { background: white; border: 1px solid #eff4f7; border-radius: 5px 5px 12px 12px; padding: 10px 4%; overflow: hidden; }
                #content > h2 { font-size: 100%; color: #666; clear: both; padding: 1.2em 0; margin: 0; }

                #menu { background: white; border: 1px solid #eff4f7; border-radius: 5px 5px 5px 5px; padding: 10px 4%; overflow: hidden; }
                #menu > h2 { font-size: 130%; color: #666; clear: both; padding: 1.2em 0; margin: 0; }
...
<?php
		if (!$isLogged) {
			/* line 88 */ $_tmp = $this->global->uiControl->getComponent("loginForm");
...
?>
                <p>
                    <a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Homepage:SignOut")) ?>">Odhlásiť</a>
                </p>
<?php
		}
?>
...
<?php
		...
		?>            <?php
		if (isset($this->blockQueue["content"])) {
...
?>
	...
	<script src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 110 */ ?>/js/main.js"></script>
        <script src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 111 */ ?>/3rd/bootstrap/js/bootstrap.js"></script>
<?php
	}

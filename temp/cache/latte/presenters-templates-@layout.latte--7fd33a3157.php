<?php
// source: D:\Programy\xampp\htdocs\CP_Idsys\app\presenters/templates/@layout.latte

use Latte\Runtime as LR;

class Template7fd33a3157 extends Latte\Runtime\Template
{
	public $blocks = [
		'head' => 'blockHead',
		'title' => 'blockTitle',
...
?>Cenové ponuky</title>
	...
	<link rel="stylesheet" href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 14 */ ?>/css/style.css">
        ...
        <style>
                ...
                #content { background: white; border: 1px solid #eff4f7; border-radius: 5px 5px 12px 12px; padding: 10px 4%; overflow: hidden; }
...
<?php
		...
		foreach ($flashes as $flash) {
			...
			echo LR\Filters::escapeHtmlText($flash->message) /* line 89 */ ?></div>
<?php
			$iterations++;
		}
...
<?php
	...
	{
		extract($this->params);
		if (isset($this->params['flash'])) trigger_error('Variable $flash overwritten in foreach on line 89');
...
?>
	...
	<script src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 96 */ ?>/js/main.js"></script>
        <script src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 97 */ ?>/3rd/bootstrap/js/bootstrap.js"></script>
<?php
	}
